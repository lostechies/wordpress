...
if(!class_exists('GoogleSyntaxHighlighterPro')){
	class GoogleSyntaxHighlighterPro{
		...
		'Vb'=>array('VB','false'),
		'Xml'=>array('XML','true'),
		'ObjC'=>array('ObjectiveC','true'));

		var $themes=array('Default','Django','Eclipse','Emacs','FadeToGrey','Midnight','RDark');

		var $languagesAlais=array('as3', 'actionscript3','bash', 'shell','c-sharp', 'csharp','cpp', 'c' ,'css' ,'delphi', 'pas', 'pascal','diff', 'patch','groovy' ,'js', 'jscript', 'javascript' , 'java' , 'jfx', 'javafx' ,'perl', 'pl' ,'php' ,'plain', 'text' ,'ps', 'powershell' ,'py', 'python' ,'ails', 'ror', 'ruby' , 'scala','sql' ,'vb', 'vbnet' ,'xml', 'xhtml', 'xslt', 'html', 'xhtml', 'obj-c', 'objc');
